...
public class SimulationSendChatroomMsg {
    ...
    public static void main(String[] args) throws IOException {
        ...
        chatRoom.addMessage(new ChatRoomMessage(user1.getNickName(),"First message!",chatRoom.getName()));
        chatRoom.addMessage(new ChatRoomMessage(user1.getNickName(),"Join someone",chatRoom.getName()));
...
//        user1.getKadNode().shutdown(false);
        ...
        user2.sendMessage(msg,chatRoomOwner,true);
